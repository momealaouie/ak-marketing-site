...
const I18N = {
  en: {
    ...
    "r1.text": '"We\'re at 5x the revenue we had before we started with AK. I was skeptical at first, but the videos are basically our whole marketing now."',
  ...
  sv: {
    ...
    "r1.text": '"Vi ligger på 5x omsättningen jämfört med innan vi började med AK. Jag var skeptisk i början, men videorna är i princip hela vår marknadsföring nu."',
    "r1.author": "Dany R, COO, Exciteclo",
