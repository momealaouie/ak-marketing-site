...
const I18N = {
  en: {
    ...
    "r1.text": '"We\'re at 5x the revenue we had before AK Media. They don\'t just film either, they run the ads and go through the numbers with us every month. We\'ve basically stopped worrying about marketing."',
    "r1.author": "Dany R, COO, Exciteclo",
    "r2.text": '"No big promises when we started, they just laid out a plan, produced the films and ran the campaigns. A couple of months in, the phone was ringing noticeably more."',
    "r2.author": "Iba A, CEO, Ademi AB",
    "r3.text": '"Our cars used to sit unsold for weeks. Now people walk in asking about a specific car they\'ve seen in one of the videos. That says it all, really."',
  ...
  sv: {
    ...
    "r1.text": '"Vi ligger på 5x omsättningen jämfört med innan AK Media. De filmar inte bara heller, de sköter annonseringen och går igenom siffrorna med oss varje månad. Vi har i princip slutat oroa oss för marknadsföringen."',
    "r1.author": "Dany R, COO, Exciteclo",
    "r2.text": '"Inga stora löften när vi började, de la fram en plan, producerade filmerna och skötte kampanjerna. Efter ett par månader ringde telefonen märkbart mer."',
    "r2.author": "Iba A, VD, Ademi AB",
    "r3.text": '"Förr kunde bilarna stå osålda i veckor. Nu kommer folk in och frågar efter en specifik bil de sett i någon av videorna. Det säger väl egentligen allt."',
