...
const I18N = {
  en: {
    ...
    "about.text": "AK Media is a results-driven agency specializing in film production and marketing for businesses. We produce commercial-grade video content and put it to work — across social media and commercial channels — with a clear goal behind every frame, measured against real numbers.",
  ...
  sv: {
    ...
    "about.text": "AK Media är en resultatdriven byrå specialiserad på filmproduktion och marknadsföring för företag. Vi producerar reklamfilm i toppklass och sätter den i arbete — på sociala medier och i kommersiella kanaler — med ett tydligt mål bakom varje bildruta, mätt mot riktiga siffror.",
    "about.how": "Så jobbar vi",
    "step1.t": "Strategi", "step1.p": "Vi analyserar er målgrupp, konkurrenter och kanaler — och sätter en plan med tydliga mål.",
