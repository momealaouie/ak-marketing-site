...
const I18N = {
  en: {
    ...
    "r1.text": '"Revenue is up 5x since we started with AK Media. That says more than I ever could."',
    "r1.author": "Dany R, COO, Exciteclo",
    "r2.text": '"Smooth from start to finish. They do what they say, and the results show."',
    "r2.author": "Iba A, CEO, Ademi AB",
    "r3.text": '"The videos bring people into the showroom. Simple as that."',
    "r3.author": "Tom B, CEO, TOM AUTO AB",
    ...
    "about.eyebrow": "About us", "about.title": "From Sweden<br>to the world.",
    "about.text": "AK Media is a results-driven film production and marketing agency. This is the journey that shaped how we work.",
    "j1.t": "The beginning", "j1.p": "AK Media started in Sweden, producing content for restaurants and influencers — fast-paced work that taught us what makes people stop scrolling.",
    "j2.t": "Into sports", "j2.p": "We stepped into the sports world by sponsoring a BJJ club, and were soon working internationally with world champions.",
    "j3.t": "Specialization", "j3.p": "We took that experience into demanding industries: automotive, food and real estate.",
    "j4.t": "Today", "j4.p": "We work across 6+ countries, with one goal above everything else: results.",
    ...
    "faq1.a": "Our pricing is customized based on each client's goals and requirements. Whether you need a single production or a complete marketing solution, we create a package that fits your needs. Reach out to discuss your project and receive a personalized quote.",
    "faq2.q": "Do you handle advertising as well, or only the production?",
    "faq2.a": "We offer both content production and advertising solutions. Depending on your goals, we can create the content, manage campaigns, optimize performance, and help turn your content into measurable growth.",
    "faq3.q": "How do you measure results?",
    "faq3.a": "We focus on measurable outcomes based on your goals. This can include metrics such as reach, engagement, leads, conversions, sales, and overall campaign performance. We use data to continuously optimize and improve results.",
    "faq4.q": "Do we need to commit to a long-term contract?",
    "faq4.a": "No. We offer flexible solutions depending on your needs. Some clients work with us on individual projects, while others choose long-term partnerships to build consistent marketing momentum.",
    "faq5.q": "Do we need to be on camera ourselves?",
    "faq5.a": "Not necessarily. We can create content around your brand, products, services, team, or customers. If you are comfortable being on camera, we can use that to build a stronger personal connection, but it is not a requirement.",
    "faq6.q": "What if we are located in another country?",
    "faq6.a": "We work internationally and can travel to you. For long-term collaborations, we create strategic content plans where we produce multiple videos and assets during one production period, giving your brand consistent content to use for months across social media, websites, and advertising.",
  ...
  sv: {
    ...
    "r1.text": '"Omsättningen har ökat 5x sedan vi började med AK Media. Det säger mer än vad jag kan."',
    "r1.author": "Dany R, COO, Exciteclo",
    "r2.text": '"Smidigt från början till slut. De gör det de säger, och resultaten syns."',
    "r2.author": "Iba A, VD, Ademi AB",
    "r3.text": '"Videorna drar in folk till bilhallen. Så enkelt är det."',
    "r3.author": "Tom B, VD, TOM AUTO AB",
    ...
    "about.eyebrow": "Om oss", "about.title": "Från Sverige<br>ut i världen.",
    "about.text": "AK Media är en resultatdriven byrå inom filmproduktion och marknadsföring. Det här är resan som format hur vi jobbar.",
    "j1.t": "Starten", "j1.p": "AK Media startade i Sverige, där vi producerade innehåll för restauranger och influencers — ett högt tempo som lärde oss vad som får folk att sluta scrolla.",
    "j2.t": "In i sporten", "j2.p": "Vi tog klivet in i sportvärlden genom att sponsra en BJJ-klubb, och arbetade snart internationellt med världsmästare.",
    "j3.t": "Specialisering", "j3.p": "Vi tog med oss erfarenheten in i krävande branscher: bilar, mat och fastigheter.",
    "j4.t": "Idag", "j4.p": "Vi arbetar i 6+ länder, med ett mål framför allt annat: resultat.",
    ...
    "faq.eyebrow": "FAQ", "faq.title": "Frågor &amp; svar.",
    "faq1.q": "Vad kostar det?",
    "faq1.a": "Vår prissättning anpassas efter varje kunds mål och behov. Oavsett om ni behöver en enskild produktion eller en komplett marknadsföringslösning skapar vi ett paket som passar er. Hör av er för att diskutera ert projekt och få en personlig offert.",
    "faq2.q": "Sköter ni annonseringen också, eller bara produktionen?",
    "faq2.a": "Vi erbjuder både innehållsproduktion och annonseringslösningar. Beroende på era mål kan vi skapa innehållet, hantera kampanjerna, optimera resultaten och hjälpa er att omvandla innehållet till mätbar tillväxt.",
    "faq3.q": "Hur mäter ni resultat?",
    "faq3.a": "Vi fokuserar på mätbara resultat utifrån era mål. Det kan till exempel vara räckvidd, engagemang, leads, konverteringar, försäljning och kampanjens övergripande resultat. Vi använder data för att löpande optimera och förbättra resultaten.",
    "faq4.q": "Måste vi binda oss till ett långt avtal?",
    "faq4.a": "Nej. Vi erbjuder flexibla lösningar beroende på era behov. Vissa kunder jobbar med oss på enskilda projekt, medan andra väljer ett långsiktigt samarbete för kontinuitet i sin marknadsföring.",
    "faq5.q": "Behöver vi själva stå framför kameran?",
    "faq5.a": "Inte nödvändigtvis. Vi kan skapa innehåll kring ert varumärke, era produkter, tjänster, ert team eller era kunder. Är ni bekväma framför kameran kan vi använda det för att bygga en starkare personlig koppling, men det är inget krav.",
    "faq6.q": "Vad gäller om vi finns i ett annat land?",
    "faq6.a": "Vi jobbar internationellt och kan resa till er. Vid långsiktiga samarbeten tar vi fram strategiska innehållsplaner där vi producerar flera videor och material under en och samma produktionsperiod, vilket ger ert varumärke innehåll för flera månader framåt i sociala medier, på webbplatser och i annonsering.",
