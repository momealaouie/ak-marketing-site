...
const I18N = {
  en: {
    ...
    "r1.text": '"We\'re at 5x the revenue we had before we started with AK Media. I was skeptical at first, but the videos are basically our whole marketing now."',
    "r1.author": "Dany R, COO, Exciteclo",
    "r2.text": '"Easy to deal with, quick, and the videos actually brought customers through the door. That\'s all I care about honestly."',
    "r2.author": "Iba A, CEO, Ademi AB",
    "r3.text": '"They filmed our cars in one afternoon and people still mention those clips when they walk into the showroom."',
  ...
  sv: {
    ...
    "r1.text": '"Vi ligger på 5x omsättningen jämfört med innan vi började med AK Media. Jag var skeptisk i början, men videorna är i princip hela vår marknadsföring nu."',
    "r1.author": "Dany R, COO, Exciteclo",
    "r2.text": '"Lätta att ha att göra med, snabba, och filmerna drog faktiskt in kunder genom dörren. Det är ärligt talat det enda jag bryr mig om."',
    "r2.author": "Iba A, VD, Ademi AB",
    "r3.text": '"De filmade våra bilar på en eftermiddag och folk nämner fortfarande klippen när de kliver in i bilhallen."',
